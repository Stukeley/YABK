...
// *******************************************************************************************
// ***                              Funckja od Boxów na ekranie                            ***
// *******************************************************************************************
const int InfoBox_PosX				= 200; //pozycja X (0-8191)
const int InfoBox_PosY				= 5000; //pozycja Y (0-8191)
const int InfoBox_SpaceBetweenBoxes		= 30; //odstêp miêdzy oknami (0-8191)
const int InfoBox_DurationMS			= 5000; //czas w milisekundach po jakim wiadomoœæ ma zacz¹æ zanikaæ 
const int InfoBox_FadeInTimeMS			= 500; //czas w milisekundach pojawiania siê wiadomoœci (przejœcie poziomu kana³u alfa z 0 do 255)
const int InfoBox_FadeOutTimeMS			= 1000; //czas w milisekundach zanikania wiadomoœci 
const int InfoBox_MoveXTimeMS			= 500; //czas w milisekundach jaki ma zaj¹æ przesuwanie siê okna w lewo do pozycji ustalonej w InfoBox_PosX
const int InfoBox_MoveYTimeMS			= 400; //czas w milisekundach jaki ma zaj¹æ przesuwanie siê okna w górê do pozycji ustalonej w InfoBox_PosY
const string InfoBox_DefaultTexture		= "InfoBox.tga"; //domyœlna tekstura
