...
{
	if((Hlp_GetInstanceID(self) != pal_1140_soeldner) && (Hlp_GetInstanceID(self) != djg_2140_soeldner) && (Hlp_GetInstanceID(self) != djg_2160_wache) && (Hlp_GetInstanceID(self) != djg_2161_wache) && (Hlp_GetInstanceID(self) != pal_1160_wache) && (Hlp_GetInstanceID(self) != pal_1161_wache))
	{
		if(((self.guild == GIL_MIL) || (self.guild == GIL_SLD)) && ((other.guild == GIL_PAL) || (other.guild == GIL_DJG)))
		{
			return;
		};
