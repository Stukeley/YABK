...
func void TA_Concert(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
...
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,ZS_Stand_RangerMeeting,waypoint);
};
...
func void ta_makerune(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
	TA_Min(self,start_h,start_m,stop_h,stop_m,zs_makerune,waypoint);
};

func void ta_muell(var int start_h,var int start_m,var int stop_h,var int stop_m,var string waypoint)
{
