...
instance ITRI_FLY(C_Item)
{
	name = "Pierœcieñ Latania";
	mainflag = ITEM_KAT_MAGIC;
	flags = ITEM_RING;
	value = Value_ItRi_Addon_STR_01;
	visual = "ItRi_Prot_Total_01.3ds";
	visual_skin = 0;
	material = MAT_METAL;
	on_equip = equip_itri_fly;
	on_unequip = unequip_itri_fly;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_ITEMGLIMMER";
	description = "Pierœcieñ Latania";
	text[2] = "";
	text[3] = "";
	text[4] = "";
	text[5] = "";
...
func void equip_itri_fly()
{
	Mdl_ApplyOverlayMds(self,"Humans_skeleton_fly.mds");
};

func void unequip_itri_fly()
{
