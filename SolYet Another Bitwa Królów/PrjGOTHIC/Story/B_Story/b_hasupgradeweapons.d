...
func int b_hasupgradearmors()
{
	if(LAGER == 1)
	{
		...
		if((FRAKTION_L1 == ORC) && (((L1_USED_ARMOR == 1) && (Npc_HasItems(hero,ItMi_Packet_ORC_2) >= 3)) || ((L1_USED_ARMOR == 2) && (Npc_HasItems(hero,ItMi_Packet_ORC_3) >= 3)) || ((L1_USED_ARMOR == 3) && (Npc_HasItems(hero,ItMi_Packet_ORC_4) >= 3))))
		{
			return TRUE;
		};
		if((FRAKTION_L1 == PCH) && (((L1_USED_ARMOR == 1) && (Npc_HasItems(hero,Itar_OldCamp_2) >= 3)) || ((L1_USED_ARMOR == 2) && (Npc_HasItems(hero,Itar_OldCamp_3) >= 3)) || ((L1_USED_ARMOR == 3) && (Npc_HasItems(hero,Itar_OldCamp_4) >= 3))))
		{
			return TRUE;
		};
	};
	if(LAGER == 2)
	{
		...
		if((FRAKTION_L2 == ORC) && (((L1_USED_ARMOR == 1) && (Npc_HasItems(hero,ItMi_Packet_ORC_2) >= 3)) || ((L2_USED_ARMOR == 2) && (Npc_HasItems(hero,ItMi_Packet_ORC_3) >= 3)) || ((L2_USED_ARMOR == 3) && (Npc_HasItems(hero,ItMi_Packet_ORC_4) >= 3))))
		{
			return TRUE;
		};
		if((FRAKTION_L2 == PCH) && (((L1_USED_ARMOR == 1) && (Npc_HasItems(hero,Itar_OldCamp_2) >= 3)) || ((L2_USED_ARMOR == 2) && (Npc_HasItems(hero,Itar_OldCamp_3) >= 3)) || ((L2_USED_ARMOR == 3) && (Npc_HasItems(hero,Itar_OldCamp_4) >= 3))))
		{
			return TRUE;
		};
	};
