...
const int DEBUG = 0;
var int load;
var int statmenucheck;
var int fraktion_l1;
var int fraktion_l2;
var int SmithGoldAmount;
const int PAL = 0;
const int DJG = 1;
const int TMP = 2;
const int SKE = 3;
...
const int BST = 6;
const int MGB = 7;
var string MojaGildia;
const int MAXFRAK = 5;
var int lager;
var int map;
const int MAP01 = 1;
const int MACHTL_MAP = 2;
const int VARUS_MAP = 3;
const int BIGMINE_GOLD = 2;
const int STARTGELD = 50;
var int botk_gewonnen;
var int muellmannstate;
var int muellmannzeit;
var int schwierigkeit;
const int DIFF_LIGHT = 1;
const int DIFF_NORMAL = 2;
const int DIFF_HEAVY = 3;
const int DIFF_HORROR = 4;
const int MageDamageSpell_1 = 50;
const int MageDamageSpell_2 = 100;
const int MageDamageSpell_3 = 150;
const int MageDamageSpell_4 = 250;
const int MageDamageSpell_5 = 400;
const int MageSpellCost_1 = 10;
const int MageSpellCost_2 = 15;
const int MageSpellCost_3 = 20;
const int MageSpellCost_4 = 25;
const int MageSpellCost_5 = 30;
var int skeletonkontroll;
var int ablauf;
var int lastsoldierspawnlagereins;
var int lastsoldierspawnlagerzwei;
var int lastmagespawnlagereins;
var int lastmagespawnlagerzwei;
var int lastskelettspawn;
var string ZlotoPosiadane;
var int Przychod;
var string PrzychodString;
var string PunktyHonoru;
var string HPTwojegoKrola;
var string HPWrogiegoKrola;
var string GoldZaKilla;
var string PoziomBohatera;
var int ReligionInnos;
var int ReligionBeliar;

const string SPAWNWAYPOINT = "TOT";

const int SCHMIEDESTEP = 1;
var int l1_schmiedestep;
var int l2_schmiedestep;
const int MAXWEAPONSTEP = 4;
const int MAXARMORSTEP = 4;
const int MAXMINENLEUTE = 6;
var int l1_minenleute;
var int l2_minenleute;
const int MAXHOEHLENWACHEN = 5;
var int l1_schmiedgegenstand;
var int l2_schmiedgegenstand;
const int SCHMIED_WAFFEN = 0;
const int SCHMIED_RUESSI = 1;
const int SCHMIED_GOLD = 2;
const int GOLD_VON_SCHMIEDE = 12;
var int l1_eisblockerforscht;
var int l1_blitzschlagerforscht;
var int l1_wundenheilenerforscht;
var int l1_rankenerforscht;
var int l1_heiltrankerforscht;
var int l1_magierupdate;
var int L1_FourthCircle;
var int L1_FifthCircle;
var int L1_SixthCircle;
var int l1_favoritspell;
var int l2_eisblockerforscht;
var int l2_blitzschlagerforscht;
var int l2_wundenheilenerforscht;
var int l2_rankenerforscht;
var int l2_heiltrankerforscht;
var int l2_magierupdate;
var int L2_FourthCircle;
var int L2_FifthCircle;
var int L2_SixthCircle;
var int l2_favoritspell;
const int POTION_HEILTRANK = 1;
const int POTION_MAGIERUPDATE = 2;
const int POTION_WACHENUPDATE = 3;
const int POTION_GOLDUPDATE = 4;
const int POTION_EHRENUPDATE = 5;
const int POTION_SMITHUPGRADE = 6;
const int POTION_FOURTHCIRCLE = 7;
const int POTION_FIFTHCIRCLE = 8;
const int POTION_SIXCIRCLE = 9;
var int l1_schmiede_erbaut;
var int l1_schmiede_erbaut_time;
var int l1_schmiede;
var int l1_aktueller_schmiede_ablauf;
var int l1_schmied_step;
var int l1_magie_erbaut;
var int l1_magie_erbaut_time;
var int l1_magie;
var int l1_zauber_erforschen;
var int l1_forschen_step;
var int l1_aktueller_forschen_step;
var int l1_trank_erforschen;
var int l1_mine_erbaut;
var int l1_mine_erbaut_time;
var int l1_mine;
var int l1_used_weapon;
var int l1_used_armor;
var int l1_soldier_level;
var int l1_mage_level;
var int l1_current_merclevel;
var int l1_wachen_level;
var int l1_get_gold;
var int l1_gold_update;
var int l1_ehre_update;
var int l2_schmiede_erbaut;
var int l2_schmiede_erbaut_time;
var int l2_schmiede;
var int l2_aktueller_schmiede_ablauf;
var int l2_schmied_step;
var int l2_magie_erbaut;
var int l2_magie_erbaut_time;
var int l2_magie;
var int l2_zauber_erforschen;
var int l2_forschen_step;
var int l2_aktueller_forschen_step;
var int l2_trank_erforschen;
var int l2_mine_erbaut;
var int l2_mine_erbaut_time;
var int l2_mine;
var int l2_used_weapon;
var int l2_used_armor;
var int l2_soldier_level;
var int l2_mage_level;
var int l2_current_merclevel;
var int l2_wachen_level;
var int l2_get_gold;
var int l2_gold_update;
var int l2_ehre_update;
var int L1_BONUSHPPERK;
var int L2_BONUSHPPERK;
var int l1_revive;
var int l2_revive;
var int l1_vampirschlag;
var int l2_vampirschlag;
var int l1_instantkill;
var int l2_instantkill;
var int l1_untoten_spawn;
var int l2_untoten_spawn;
var int l1_ehrenpunkte;
var int l2_ehrenpunkte;
var int l1_held_schwertlevel;
var int l1_held_ruestunglevel;
var int l1_held_armbrustlevel;
var int l1_held_skilllevel;
var int l1_held_tot;
var int l1_held_spawned;
var int l2_held_schwertlevel;
var int l2_held_ruestunglevel;
var int l2_held_armbrustlevel;
var int l2_held_skilllevel;
var int l2_held_tot;
var int l2_held_spawned;
var int l1_held_quickrevive;
var int l2_held_quickrevive;
const int TOTEGEGNERFUERSKILLLEVEL = 4;
const int HERO_WAITFORREVIVE_NORMAL = 8;
const int HERO_WAITFORREVIVE_SHORT = 2;
var int l1_havegold;
var int l1_haveweapons;
var int l1_havearmors;
var int l2_havegold;
var int l2_haveweapons;
var int l2_havearmors;
var int l1_lebendeminenwachen;
var int l2_lebendeminenwachen;
var int l1_lebendehoehlensoeldner;
var int l2_lebendehoehlensoeldner;
var int l1_lebendeminenarbeiter;
var int l2_lebendeminenarbeiter;
var int reactonmercs;
var int herospawned;
const int KING_CHAPTER = 7;
const int KING_FIGHTSKILL = 100;
const int SMITHCOST = 50;
const int MAGECOST = 45;
const int MINENCOST = 55;
const int MINENARBEITERCOST = 60;
const int HERO_COST = 50;
const int HERO_WAFFENUPGRADE = 80;
const int HERO_RUESTUNGSUPGRADE = 80;
const int HERO_ARMBRUSTUPGRADE = 100;
const int HERO_QUICKREVIVE = 80;
const int BLITZSCHLAG_COST = 70;
const int EISBLOCK_COST = 70;
const int RANKEN_COST = 45;
const int HEILUNG_COST = 15;
const int HEILTRANK_COST = 20;
const int MAGIERUPDATE_COST = 50;
const int MAGIERUPDATE_COST_3 = 50;
const int MAGIERUPDATE_COST_4 = 50;
const int MAGIERUPDATE_COST_5 = 50;
const int SMITHUPGRADE_COST = 150;
const int WACHEN_UPDATE_PER_LEVEL = 20;
const int GOLD_UPDATE = 60;
const int COSTPERLEVELSTEP = 50;
const int GOLDPERDEATH = 13;
const int GOLDPEROWNDEATH = 13;
const int SOELDNERLEVEL1_COST = 15;
const int SOELDNERLEVEL2_COST = 45;
const int SOELDNERLEVEL3_COST = 100;
const int SOELDNERLEVEL4_COST = 205;
const int SOELDNERLEVEL5_COST = 190;
const int WACHE_COST = 30;
const int MINENARBEITERSOELDNER = 20;
const int MINENWACHE = 65;
const int HOEHLENSOELDNER = 65;
const int BONUSHPPERK_COST = 60;
const int GOLD_COST = 4;
const int GOLD_FUER_EHRENPUNKTE = 20;
const int MERC_COST = 40;
const int MERC_FUER_EHRENPUNKTE = 2;
const int KLAU_COST = 16;
const int KLAU_FUER_EHRENPUNKTE = 90;
const int KINGHEAL_COST = 40;
const int KING_HEAL_PROZENT = 10;
const int REVIVE_COST = 80;
const int REVIVAL_CHANCE = 18;
const int VAMPIR_COST = 80;
const int VAMPIR_CHANCE = 10;
const int VAMPIR_HEAL = 60;
const int INSTANTKILL_COST = 80;
const int INSTANTKILL_CHANCE = 10;
const int UNTOTENRESPAWN_COST = 80;
const int UNTOTENRESPAWN_CHANCE = 15;
var string PoziomTwojegoMaga;
var int wegcounter;
var int l1_wegaufteilung;
var int l2_wegaufteilung;
var int giverunen;
var int l1_aktiveminenarbeiter;
var int l2_aktiveminenarbeiter;
var int twosoldiers_on;
var int twomages_on;
var int passive_perks;
var int nomercs_on;
var int nostartmoney;
var int instantweapons;
var int nonews_on;
...
func void b_varinitialisierung()
{
	L1_USED_WEAPON = 1;
	L1_USED_ARMOR = 1;
	L1_SOLDIER_LEVEL = 1;
	...
	L1_WEGAUFTEILUNG = 2;
	L2_WEGAUFTEILUNG = 2;
	L1_SCHMIEDESTEP = SCHMIEDESTEP;
	L2_SCHMIEDESTEP = SCHMIEDESTEP;
};
