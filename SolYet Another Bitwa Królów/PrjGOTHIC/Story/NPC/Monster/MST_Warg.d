...
instance WARG_01(Mst_Default_Warg)
{
	B_SetVisuals_WARG();
	Npc_SetToFistMode(self);
};

instance WARG_02(Mst_Default_Warg)
{
	B_SetVisuals_WARG();
	Npc_SetToFistMode(self);
};

instance WARG_03(Mst_Default_Warg)
{
	B_SetVisuals_WARG();
	Npc_SetToFistMode(self);
};

instance MIL_WARG(Mst_Default_Warg)
{
	name[0] = "Rot - Gezähmter Warg";
	B_SetVisuals_WARG();
	Npc_SetToFistMode(self);
	guild = GIL_MIL;
};

instance SLD_WARG(Mst_Default_Warg)
{
	name[0] = "Blau - Gezähmter Warg";
	B_SetVisuals_WARG();
	Npc_SetToFistMode(self);
	guild = GIL_SLD;
};
