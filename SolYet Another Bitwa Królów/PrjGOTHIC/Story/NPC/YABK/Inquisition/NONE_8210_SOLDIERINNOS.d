instance NONE_8210_SOLDIERINNOS(Npc_Default)
{
	var int Face;
	Face = Hlp_Random(20);
	Face = Face+65;
	...
	{
		EquipItem(self,ITMW_Inquisition_2);
	}
	else if (L2_USED_WEAPON == 3)
	{
		EquipItem(self,ITMW_Inquisition_3);
	}
	else if (L2_USED_WEAPON == 4)
	{
		EquipItem(self,ITMW_Inquisition_4);
	};

	if (L2_USED_ARMOR == 1)
	{
		B_SetNpcVisual(self,MALE,"Hum_Head_Fighter",Face,BodyTex_N,Itar_Inquisition_1);
	}
	else if (L2_USED_ARMOR == 2)
	{
		B_SetNpcVisual(self,MALE,"Hum_Head_Fighter",Face,BodyTex_N,Itar_Inquisition_2);
	}
	else if (L2_USED_ARMOR == 3)
	{
		B_SetNpcVisual(self,MALE,"Hum_Head_Fighter",Face,BodyTex_N,Itar_Inquisition_3);
	}
	else if(L2_USED_ARMOR == 4)
	{
		B_SetNpcVisual(self,MALE,"Hum_Head_Fighter",Face,BodyTex_N,Itar_Inquisition_4);
	};
	id = 8210;
	daily_routine = rtn_lager1_8210;
};

func void rtn_lager1_8210()
{
	TA_RunToWP(8,0,23,0,"L2_KING_01");
	TA_RunToWP(23,0,8,0,"L2_KING_01");
};

func void rtn_tot_8210()
{
	TA_Stand_WP(8,0,23,0,"TOT");
	TA_Stand_WP(23,0,8,0,"TOT");
};

func void rtn_lager2_8210()
{
	TA_Stand_WP(8,0,23,0,"L1_KING_02");
	TA_Stand_WP(23,0,8,0,"L1_KING_02");
};
