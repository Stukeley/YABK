...
instance PAL_3300_Mage(Npc_Default)
{
	guild = GIL_NONE;
	id = 3300;
	voice = 6;
	...
	daily_routine = Rtn_Start_3300;
};


func void Rtn_Start_3300()
{
	TA_Read_Bookstand  (8,0,23,0,"L2_MAGIE_05");
	TA_Read_Bookstand  (23,0,8,0,"L2_MAGIE_05");
};
