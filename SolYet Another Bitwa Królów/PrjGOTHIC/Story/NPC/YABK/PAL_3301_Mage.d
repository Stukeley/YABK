...
instance PAL_3301_Mage(Npc_Default)
{
	guild = GIL_NONE;
	id = 3301;
	voice = 6;
	...
	daily_routine = Rtn_Start_3301;
};


func void Rtn_Start_3301()
{
	TA_Read_Bookstand  (8,0,23,0,"L2_MAGIE_06");
	TA_Read_Bookstand  (23,0,8,0,"L2_MAGIE_06");
};
